...
abstract class SimpleSAML_Auth_Source
{
    ...
    public function reauthenticate(array &$state)
    {
        ...
        error_log("____________________ get from sessions , state = "+json_encode($state));
    ...
    public static function loginCompleted($state)
    {
        ...
        if (is_string($return)) { // redirect...
            \SimpleSAML\Utils\HTTP::redirectTrustedURL($return);
             //error_log("_____________redirect==".$return);
        } else {
            //error_log("_____________redirect call func==".$return);
