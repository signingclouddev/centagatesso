...
class SimpleSAML_IdP
{
    ...
    public static function postAuth(array $state)
    {
        ...
        //error_log("___________POST AUTH .... , state = ".json_encode($state['nameID']));
        ...
        $state['Attributes']['nameID']=array($state['nameID']);
        //error_log("___________POST AUTH .... , ATTR =". json_encode($state['Attributes']));
