...
$(document).ready(function () {
    ...
    $("#menuKeys").hover(function () {
        subMenuHideAll("ulKeys");
        clearTimeout(menuKeys);
        subMenuAddHover("menuKeys");
        $('#ulKeys').fadeIn();
    }, function () {
        menuKeys = setTimeout(function () {
            $('#ulKeys').fadeOut();
            subMenuRemoveHover("menuKeys");
        }, 1000);
    });

    $("#menuGroup").hover(function () {
        subMenuHideAll("ulGroup");
        clearTimeout(menuGroup);
        subMenuAddHover("menuGroup");
        $('#ulGroup').fadeIn();
    }, function () {
        menuGroup = setTimeout(function () {
            $('#ulGroup').fadeOut();
    ...
    $("#menuRules").hover(function () {
        ...
        clearTimeout(menuRules);
        subMenuAddHover("menuRules");
        $('#ulRules').fadeIn();
    }, function () {
        menuRules = setTimeout(function () {
            $('#ulRules').fadeOut();
    ...
    $(function () {
        ...
        $("#com_validateinput_confirmation").dialog({
            open: function (event, ui) {                                
                //$(this).parent().css({'border': '2px solid red', 'z-index': '10000'});
                if (hasScrollBar()) {
        ...
        $("#selfservice_save_reset_password").dialog({
            open: function(event, ui) {
                if (hasScrollBar()) {
                    $("html").css({'margin-left': '-17px', overflow: 'hidden'});
                    $(document).keydown(function(e) {
        ...
        $("#key_activate_confirmation").dialog({
            open: function (event, ui) {
                if (hasScrollBar()) {
                    $("html").css({'margin-left': '-17px', overflow: 'hidden'});
                    $(document).keydown(function (e) {
        ...
        $("#key_revoke_confirmation").dialog({
            open: function (event, ui) {
                if (hasScrollBar()) {
                    $("html").css({'margin-left': '-17px', overflow: 'hidden'});
                    $(document).keydown(function (e) {
        ...
        $("#key_generate_confirmation").dialog({
            open: function (event, ui) {
                if (hasScrollBar()) {
                    $("html").css({'margin-left': '-17px', overflow: 'hidden'});
                    $(document).keydown(function (e) {
...
function subMenuRemoveAllHover() {
    ...
    $('#menuKeys').removeClass("hover");
    $('#menuKeys').children('a').removeClass("hover");
...
function initSubMenu() {
    $('#ulDashboard').width(300);
    $('#ulCompanies').width(220);
    $('#ulSelfService').width(630);    
    $('#ulKeys').width(200);
    $('#ulGroup').width(200);
    $('#ulRules').width(400);
    $('#ulAdministrators').width(540);
    $('#ulActivities').width(650);    
    $('#ulTokens').width(400);
    

    if ($('#ulCertificates').length > 0)
        $('#ulCertificates').width(540);
    else
        $('#ulCertificatesShort').width(120);
...
function navigate(url, param) {
    if ( ! window.location.pathname.endsWith ( "index.xhtml" ) && window.history.replaceState )
        window.history.replaceState ( "" , "CENTAGATE" , "index.xhtml" ) ;
...
function msgbox(id, msg) {
    ...
    $('#' + id).height('170');        
    $('#' + id).dialog('open');
    //$('#' + id).children().css({"border":"5px solid blue","left":"500px"});
}
