    ...
    else if ( isset ( $_SESSION [ "auth_static" ] ) && $_SESSION [ "auth_static" ] == true )
    {
        ...
        else
        {
			...
			else if ( $request_otp_challenge == "1" )
			{
                ...
                try
                {
                  //error_log("__________RESUEST CROTP ________________");
			...
			else if ( $request_mobile_soft_cert == "1" )
			{
				...
				try
				{
                              ...
                              //error_log("__________RESUEST mobile cert________________");
                               // error_log("______________mobile soft cert_____________");
			...
			{
                             //error_log("___________________request mobile push_______________");
